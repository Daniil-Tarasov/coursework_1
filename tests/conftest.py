...
def transactions() -> pd.DataFrame:
    transactions_data = [
        {"Дата операции": "20.09.2021 12:45:12", "Дата платежа": "20.09.2021", "Номер карты": "*7197", "Категория": "Супермаркеты", "Сумма операции с округлением": 200.00},
        {"Дата операции": "15.11.2021 01:02:03", "Дата платежа": "15.11.2021", "Номер карты": "*7197", "Категория": "Супермаркеты", "Сумма операции с округлением": 150.00},
        {"Дата операции": "10.12.2021 12:12:12", "Дата платежа": "10.12.2021", "Номер карты": "*7197", "Категория": "Супермаркеты", "Сумма операции с округлением": 100.00},
        {"Дата операции": "22.12.2021 00:00:00", "Дата платежа": "22.12.2021", "Номер карты": "*7197", "Категория": "Другие", "Сумма операции с округлением": 50.00},
        {"Дата операции": "01.10.2021 12:12:13", "Дата платежа": "01.10.2021", "Номер карты": "*7197", "Категория": "Супермаркеты", "Сумма операции с округлением": 100.00},
    ]
...
def small_operations() -> pd.DataFrame:
    transactions_data = [
        {"Дата операции": "20.09.2021 12:45:12", "Номер карты": "*7197", "Категория": "Супермаркеты", "Описание": "Магнит", "Сумма операции с округлением": 200.00}]
    transactions_df = pd.DataFrame(transactions_data)
    return transactions_df
